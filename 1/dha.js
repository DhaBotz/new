...
module.exports = dha = async (dha, mek) => {
 ...
 //button       
constsendButton = async (from, context, fortext, but, mek) => {
buttonMessages = {
contentText: context,
footerText: fortext,
buttons: but,
...
//Zona Nyaman           
           ...
           case 'owner': case 'creator':
               ...
               break      
case 'menu':         
dha.sendMessage(from,  awalMenu(prefix),MessageType.text, footerText: 'NOTE: Silahkan Ketik .allmenu Jika Tombol Dibawah Tidak Muncul!', buttons: [{ buttonId: `!simpelmenu`, buttonText: { displayText: 'LIST MENU' }, type: 1 },{ buttonId: `!storemenu`, buttonText: { displayText: ' LIST STORE' }, type: 1 },{ buttonId: `!rules`, buttonText: { displayText: 'RULES' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: fakeimage, contextInfo: {mentionedJid: [sender]}}, 'buttonsMessage')
 break                
...
• ${prefix}caklontong
• ${prefix}tebakgambar`
               dha.sendMessage(from, menu, text, {quoted: mek, contextInfo: {mentionedJid: [sender], externalAdReply: { title: 'dha Bot', thumbnailUrl: 'https://telegra.ph/file/ad408bff29a90b6627e6f.jpg', sourceUrl: 'https://github.com/dha-chan02/' }}})
               break
//------------------< Sticker Cmd >-------------------
...
//------------------< Downloader/Search/Anime >-------------------
          case 'nhentaisearch': case 'nhsearch':
              if (!q) return reply(`Example: ${prefix}nhentaisearch Nakano dha`)
              rowsdata = [];
...
//------------------< Lainnya >-------------------
          ...
          case 'welcome':
              ...
              break
          case 'infoig':
              teks = `Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/dha.chan26/`
              dha.sendMessage(from, teks, text, { quoted : mek })
              break
          case 'sourcecode': case 'sc': case 'src':
              textImg(`Bot ini menggunakan sc : https://github.com/dha-chan02/SelfBotz`)
              break
          case 'q':
